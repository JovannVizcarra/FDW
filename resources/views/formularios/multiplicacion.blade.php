@extends('app')
@section('title',"Multiplicacion de dos numero")
@section('content')
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
              <div class="card shadow-2-strong" style="border-radius: 1rem;">
                <div class="card-body p-5 text-center">
                  <h3 class="mb-5">Operacion Multiplicacion</h3>
                  ...
                  <button class="btn btn-primary btn-lg btn-block" type="submit">Multiplicar</button>
                  </form>
                </div>
              </div>
            </div>
